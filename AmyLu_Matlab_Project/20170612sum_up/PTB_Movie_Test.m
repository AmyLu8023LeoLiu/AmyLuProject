...
%% 视频播放
VideoFileName='C:\Users\Amy Lu\Desktop\AmyLu_Matlab_Project\testspeed\yanzheng\01-01.mp4'
...
while (1) % 逐帧播放视频
	...
	DrawFormattedText(window, double(['速度:',num2str(speed)]), 'center', screenYpixels/8, Color_white); % window,文字,X坐标，Y坐标，颜色
